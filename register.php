...
<body dir="rtl">
	...
	<div class="container home">
		<div class="row">
			<div class="col-md-12">
				<h1 class="display-1">عضویت در سایت</h1>
				<form method="post" action="">
					...
					<p><input type="submit" class="btn btn-success" value="ثبت نام"></p>
				</form>
				...
				if( isset($_POST['emailmobile']) && isset($_POST['password']) ) {
					if( empty($_POST['emailmobile']) || empty($_POST['password']) )
						...
						if(!file_exists("data/users.json")) {
							echo '<p class="alert alert-danger">مشکلی در عملیات ثبت نام  رخ داده است.</p>';
						}
						else {
							...
							array_push(
								$json, array(
									"username" => utf8_encode($_POST['emailmobile']), "password" => utf8_encode($_POST['password'])
								)
							);
							file_put_contents("data/users.json", json_encode($json));

							echo '<p class="alert alert-success">ثبت نام با موفقیت انجام شد برای ادامه لطفا  <a href="register.php">وارد سایت شوید.</a></p>';
						}
					}
				}
